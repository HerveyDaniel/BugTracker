...
public class UserServiceImpl implements UserService{
    ...
    @Override
    public Users createUser(Map<String, String> requestData) throws Exception{//will probably have to implement builder
...
//        Role role = objectMapper.readValue(requestData.get("role"), new TypeReference<Role>() {});
//        Role userRole = Role.valueOf(requestData.get("role"));
